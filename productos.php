...
$cartas = [
    ["titulo" => "Productos por CATEGORIA", "icono" => "fa fa-box", "total" => count($productos), "color" => "#3578FE"],
    ["titulo" => "Total Productos", "icono" => "fa fa-shopping-cart", "total" => obtenerNumeroProductos(), "color" => "#4F7DAF"],
    ["titulo" => "Total en Productos", "icono" => "fa fa-money-bill", "total" => "S/.". obtenerTotalInventario(), "color" => "#1FB824"],
    ["titulo" => "Ganancia en Inventario", "icono" => "fa fa-wallet", "total" => "S/.". calcularGananciaProductos(), "color" => "#D55929"],
];
?>
